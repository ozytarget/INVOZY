            ...
            <header className="flex justify-between items-start mb-8">
              <div>
                ...
                <div className="text-muted-foreground">
                  <p className="font-bold text-foreground text-lg">{documentData.companyName || "⚠️ Company Name Not Set"}</p>
                  <p className="whitespace-pre-line text-sm">{documentData.companyAddress || "⚠️ Address Not Set"}</p>
                  {documentData.companyEmail && <p className="text-sm">{documentData.companyEmail}</p>}
                  {documentData.companyPhone && <p className="text-sm">{documentData.companyPhone}</p>}
                  {documentData.taxId && <p className="text-sm">Tax ID: {documentData.taxId}</p>}
                  {(!documentData.companyName || !documentData.companyAddress) && (
                    <p className="text-sm text-orange-600 mt-2">👉 <Link href="/dashboard/manage" className="underline font-semibold">Set company info in settings</Link></p>
                  )}
                </div>
              </div>
